#ifndef LC_PROT_LCFU___AOANALOGOUTPUT__H
#define LC_PROT_LCFU___AOANALOGOUTPUT__H

#include <LC3CGBase.h>
#include <lcdt___aoanalogoutput_instancedata.h>
#include <lcdt___dt_status.h>
#include <lcdt___enu_reliability.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_AOANALOGOUTPUT
{
...
} LCCG_StructAttrib LC_TD_FunctionBlock_AOANALOGOUTPUT;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_AOANALOGOUTPUT(p) \
{ \
...
#define LC_WINIT_FunctionBlock_AOANALOGOUTPUT(p,RF) \
{ \
